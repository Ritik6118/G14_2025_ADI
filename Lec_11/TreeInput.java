...
//		Node root = CreateTreeInt(n);
	...
	private static Node CreateTree() { // recursive function
		// TODO Auto-generated method stub
		int n = sc.nextInt(); // input of root node from user
		Node nn = new Node(n); // creating a new node for root node of tree
